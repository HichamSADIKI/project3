...
export type NavKey =
  ...
  | "erp" | "workspace" | "audit"
  | "appadmin" | "appadmin_users" | "appadmin_audit" | "appadmin_alerts" | "appadmin_infra" | "appadmin_backups" | "appadmin_honeytokens" | "appadmin_self_defense" | "appadmin_studio"
...
export const NAV_ENTRIES: NavEntry[] = [
  ...
  { type: "group", id: "realestate",   groupKey: "realestate", icon: <IcProp />,
    children: [
      ...
      { key: "realestate_technicians", icon: <IcPersonne />, section: "tiers" },
