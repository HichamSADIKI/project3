...
export type NavKey =
  ...
  | "erp" | "workspace" | "audit"
  | "appadmin" | "appadmin_users" | "appadmin_audit" | "appadmin_alerts" | "appadmin_infra" | "appadmin_backups" | "appadmin_honeytokens"
...
export function navLabelFor(t: Translations, key: NavKey): string {
  const map: Record<NavKey, string> = {
    ...
    appadmin: t.nav_appadmin, appadmin_users: t.nav_appadmin_users, appadmin_audit: t.nav_appadmin_audit, appadmin_alerts: t.nav_appadmin_alerts, appadmin_infra: t.nav_appadmin_infra, appadmin_backups: t.nav_appadmin_backups, appadmin_honeytokens: t.nav_appadmin_honeytokens,
