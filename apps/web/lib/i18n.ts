...
export type Translations = {
  ...
  nav_appadmin: string; nav_appadmin_users: string; nav_appadmin_audit: string; nav_appadmin_alerts: string; nav_appadmin_infra: string; nav_appadmin_backups: string; nav_appadmin_honeytokens: string; nav_appadmin_self_defense: string; nav_appadmin_studio: string; nav_appadmin_crudgen: string; nav_appadmin_security: string;
