...
export type Translations = {
  ...
  nav_appadmin: string; nav_appadmin_users: string; nav_appadmin_audit: string; nav_appadmin_alerts: string; nav_appadmin_infra: string; nav_appadmin_backups: string; nav_appadmin_honeytokens: string; nav_appadmin_self_defense: string;
  ...
  or: string; login_uaepass: string;
...
const ar: Translations = {
  ...
  nav_appadmin: "إدارة التطبيق", nav_appadmin_users: "المستخدمون والصلاحيات", nav_appadmin_audit: "التدقيق والأمان", nav_appadmin_alerts: "التنبيهات", nav_appadmin_infra: "الخوادم والشبكة", nav_appadmin_backups: "النسخ الاحتياطي", nav_appadmin_honeytokens: "الرموز الخادعة", nav_appadmin_self_defense: "الدفاع الذاتي",
  ...
  or: "أو", login_uaepass: "تسجيل الدخول عبر UAE Infinity PASS",
  ...
  assistant_prefill: "ملء النموذج", assistant_recenter: "إعادة توسيط المساعد",
  // Lot 3 — documents
...
const en: Translations = {
  ...
  nav_appadmin: "App Administration", nav_appadmin_users: "Users & Permissions", nav_appadmin_audit: "Audit & Security", nav_appadmin_alerts: "Alerts", nav_appadmin_infra: "Servers & Network", nav_appadmin_backups: "Backups", nav_appadmin_honeytokens: "Honeytokens", nav_appadmin_self_defense: "Self-Defense",
  ...
  or: "OR", login_uaepass: "Sign in with UAE Infinity PASS",
  ...
  assistant_prefill: "Pre-fill the form", assistant_recenter: "Recenter assistant",
  // Lot 3 — documents
...
const fr: Translations = {
  ...
  nav_appadmin: "Administration application", nav_appadmin_users: "Utilisateurs & permissions", nav_appadmin_audit: "Audit & sécurité", nav_appadmin_alerts: "Alertes", nav_appadmin_infra: "Serveurs & réseau", nav_appadmin_backups: "Sauvegardes", nav_appadmin_honeytokens: "Honeytokens", nav_appadmin_self_defense: "Self-Defense",
  ...
  or: "OU", login_uaepass: "Se connecter avec UAE Infinity PASS",
  ...
  assistant_prefill: "Pré-remplir le formulaire", assistant_recenter: "Recentrer l'assistant",
  // Lot 3 — documents
