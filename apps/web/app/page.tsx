...
import { ScreenRealEstateTechnicians } from "./screens/realestate-technicians";
...
type ScreenKey =
  ...
  | "appadmin_users" | "appadmin_audit" | "appadmin_alerts" | "appadmin_infra" | "appadmin_backups" | "appadmin_honeytokens" | "appadmin_self_defense" | "appadmin_studio"
...
const SCREEN_REGISTRY: Record<ScreenKey, (props: ScreenProps) => React.ReactNode> = {
  ...
  "realestate_technicians": (_) => <ScreenRealEstateTechnicians />,
