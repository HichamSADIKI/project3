...
class CompanySettings(Base, TimestampMixin, TenantMixin):
    ...
    default_emirate: Mapped[str] = mapped_column(String(3), nullable=False, default="DXB")
    timezone: Mapped[str] = mapped_column(String(50), nullable=False, default="Asia/Dubai")
    ...
    contract_prefix: Mapped[str] = mapped_column(String(10), nullable=False, default="CTR")
    ...
    __table_args__ = (Index("uq_company_settings_company", "company_id", unique=True),)
