...
export type Translations = {
  ...
  nav_appadmin: string; nav_appadmin_users: string; nav_appadmin_audit: string; nav_appadmin_infra: string; nav_appadmin_backups: string;
...
const ar: Translations = {
  ...
  nav_appadmin: "إدارة التطبيق", nav_appadmin_users: "المستخدمون والصلاحيات", nav_appadmin_audit: "التدقيق والأمان", nav_appadmin_infra: "الخوادم والشبكة", nav_appadmin_backups: "النسخ الاحتياطي",
...
const en: Translations = {
  ...
  nav_appadmin: "App Administration", nav_appadmin_users: "Users & Permissions", nav_appadmin_audit: "Audit & Security", nav_appadmin_infra: "Servers & Network", nav_appadmin_backups: "Backups",
...
const fr: Translations = {
  ...
  nav_appadmin: "Administration application", nav_appadmin_users: "Utilisateurs & permissions", nav_appadmin_audit: "Audit & sécurité", nav_appadmin_infra: "Serveurs & réseau", nav_appadmin_backups: "Sauvegardes",
