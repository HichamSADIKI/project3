...
export const SEARCH_INDEX: SearchItem[] = [
  ...
  { id: "nav-bank",      category: "navigation", label: "Bank reconciliation",   label_ar: "التسوية البنكية",     label_fr: "Rapprochement bancaire", screen: "bank_recon", emoji: "🏦", keywords: "bank reconciliation rapprochement bancaire releve statement match matching transactions auto-match import csv" },
