/**
 * GET /api/admin/clients — proxy vers le backend FastAPI.
 *
 * Lit le cookie sgi-session, ajoute Bearer Authorization, relaie l'appel
 * vers /api/v1/clients/ (avec query params `type`, `q`, `page`, `limit`).
 *
 * Utilisé par le back-office (apps/web) pour afficher la liste des clients
