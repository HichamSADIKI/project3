...
| doc compagnon `module-securite-specification-operationnelle.md` | ✅ présent (spec opérationnelle = doctrine cible) | `docs/security/` |
...
Détails opérationnels (catalogue exhaustif des paramètres surveillés par axe, 14 actions
de réponse, 10 playbooks pas à pas, calendrier d'audit, KPI) → doc compagnon :
[docs/security/module-securite-specification-operationnelle.md](../security/module-securite-specification-operationnelle.md).
